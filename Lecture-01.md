...
title: "Lecture 1: Introduction to Project Management"
mdc: true
...
<div>
<img src="./media/1/stakeholder.jpg">
</div>
</div>
---
...
```mermaid {theme: 'penguin', scale: 1}
flowchart LR
Start --> Plan --> Execute --> Finish
```
...
## Development Models
- Waterfall
```mermaid {theme: 'penguin', scale: 0.7}
flowchart LR
...
## Development Models
- Spiral
<img src="./media/1/Spiral.png" style="width: 75%">
---
...
## Development Models
- Iterative
<img src="./media/1/Iterative.png" style="width: 75%">
---
